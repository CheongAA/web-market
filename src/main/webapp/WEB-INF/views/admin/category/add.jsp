				...
				<tbody>
					<c:forEach var="category" items="${categories}" varStatus="status">
						<tr>
							...
							<td><a href="${pageContext.request.contextPath}/admin/category/${category.category_code}">
			...
			<form class="m-auto"
				...
				<div class="form-group">
					<label class="form-check form-check-inline"> <input
						class="form-check-input" type="radio" name="category_depth"
						value="1" checked required> <span class="form-check-label">
							대분류</span>
					</label> <label class="form-check form-check-inline"> <input
						class="form-check-input" type="radio" name="category_depth"
						value="2" required> <span class="form-check-label">
							중분류</span>
					</label>
				</div>
				<div class="form-group" id="large">
					<label for="category1">대분류</label> <select class="form-control"
						name="category_code2" id="largeSelect">
				...
				<div class="form-group">
					<label for="category_code">코드</label> <input type="number"
						class="form-control" id="category_code" name="category_code"
						min="1" max="10000" required="required">
				</div>
				<div class="form-group">
