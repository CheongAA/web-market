...
<body>
	...
	<div class="row mt-5">
		...
		<div class="jumbotron w-100 text-center"
			style="background: url(${discount.discount_thumbnailImg }) no-repeat; background-size: cover;">
				...
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<a type="button" class="btn btn-danger"
							href="${pageContext.request.contextPath}/admin/discount/delete/${discount.discount_id}">삭제하기</a>
					</div>
				</div>
			</div>
		</div>
