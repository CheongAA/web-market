...
<body>
	...
	<div class="row mt-5">
		...
		<div class="col-sm-12 p-5">
			<form action="${pageContext.request.contextPath}/admin/brand/update"
						...
						<tbody>
							<tr>
								...
								<td class="form-inline"><input type="text"
									...
									required="required" value="${brand.brand_name }"></td>
							</tr>
							<tr>
								...
								<td><input type="file" class="form-control-file"
									...
									<div class="select_brand_img mt-3">
										<input type="hidden" name="brand_img"
											value="${brand.brand_img}" /> <img class="w-75 mb-2"
											src="${brand.brand_img}" id="origin_brand_img"> 
							...
							<tr>
								...
								<td><textarea class="form-control" id="brand_desc"
										name="brand_desc" rows="3" required="required">${brand.brand_desc }</textarea></td>
							</tr>
						</tbody>
					</table>
				</div>
