...
<body>
	...
	<div class="w-100 my-5">
		<a href="${pageContext.request.contextPath}/admin/brand" class="btn btn-dark float-right mx-5">목록</a>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<ul class="text-danger">
							...
							<li>삭제 후에는 상품과 주문서를 <strong>복원할 수 없으니</strong> 이 점 유의바랍니다.
							</li>
						</ul>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary" data-dismiss="modal">취소</button>
						<a type="button" class="btn btn-danger" href="${pageContext.request.contextPath}/admin/brand/delete/${brand.brand_id}">삭제하기</a>
					</div>
				</div>
			</div>
		</div>
		<a href="${pageContext.request.contextPath}/admin/brand/update/${brand.brand_id}" class="btn btn-warning float-right px-5 mr-1">수정</a>
	</div>
