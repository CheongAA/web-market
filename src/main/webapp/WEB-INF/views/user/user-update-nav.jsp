...
<body>
	<div class="row">
		...
		<div class="col py-5 ml-5">
			...
			<div class="row pt-5">
				<div class="col-sm-4">
					<a class="btn btn-block btn-secondary text-white p-5"
						href="${pageContext.request.contextPath}/user/update">개인정보수정</a>
				</div>
				<div class="col-sm-4">
				...
				<div class="col-sm-4">
					<button type="button" class="btn btn-block btn-secondary text-white p-5" id="cancel_btn"
