			...
			<div>
				...
				<ul>
					<li>상품에 대한 문의를 남기는 공간입니다. 해당 게시판의 성격과 다른 글은 사전동의 없이 담당 게시판으로
						이동될 수 있습니다.</li>
					<li>배송관련, 주문(취소/교환/환불)관련 문의 및 요청사항은 마이페이지 내 <a
						...
						<tbody>
							<tr>
								...
								<td><input type="text"
									...
									value="${category.question_category_title}" readonly><input
									type="text" name="question_title" class="form-control col-sm-5"
									required></td>
							</tr>
							<tr>
								<th scope="row" class="table-secondary">상품명 *</th>
								<td class="form-inline"><input type="text"
									class="form-control col-sm-5 mr-3" value="${product.product_name }" readonly></td>
							</tr>
							<tr>
