		...
		<div class="col py-5 ml-5">
			...
			<div class="row mt-5">
				<a
					...
					href="${pageContext.request.contextPath}/user/reviewable">작성 가능한 구매목록</a> <a
					class="border-top border-left border-right bg-white h5 p-3 m-0 text-dark text-decoration-none col-6"
					href="${pageContext.request.contextPath}/user/reviewlist">내가 쓴 구매후기</a>
			</div>
										...
										<div class="row border-bottom">
											...
											<div class="col-sm-3 text-center my-auto p-2">
												<a class="btn btn-sm btn-outline-primary btn-block"
													href="${pageContext.request.contextPath}/user/order/${order.order_id}">후기쓰기</a>
											</div>
										</div>
									</c:if>
								</c:forEach>
