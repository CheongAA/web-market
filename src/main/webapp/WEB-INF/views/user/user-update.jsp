						...
						<article class="card-body">
							<form:form action="/user/update" method="post" autocomplete="off">
								...
								<div class="form-group">
									<label>아이디</label>
									<input type="text" name="user_identification" id="user_identification" class="form-control" required="required" readonly="readonly" value="${user.user_identification}">
								</div>
								<div class="form-group">
									<label>이름</label>
									<input type="text" name="user_name" id="user_name" class="form-control" required="required" readonly="readonly" value="${user.user_name}">
								</div>
								...
								<div class="form-group">
									<label>생년월일 (선택)</label>
									<input type="date" name="user_birth" class="form-control" placeholder="" max="${today}" value="${user.user_birth}">
								</div>
								<div class="form-group">
									<label>이메일</label>
									<input type="email" name="user_email" id="user_email" class="form-control" required="required" value="${user.user_email}">
									<small class="form-text text-danger" id="validation_email"></small>
								</div>
								<div class="form-group">
									<label>핸드폰번호</label>
									<input type="text" name="user_phone" id="user_phone" class="form-control" required="required" value="${user.user_phone}">
								...
								<div class="form-row">
									...
									<div class="col form-group">
										...
										<a href="/user/address" class="btn btn-secondary btn-sm" id="address_btn"> 배송지 추가</a>
									</div>
								</div>
